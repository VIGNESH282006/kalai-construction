...
const pricingPlans: PricingTier[] = [
    {
        ...
        price: 2200,
        description: "Quality construction with branded materials for budget-conscious projects",
        icon: Home,
    ...
    },
    {
        ...
        price: 2400,
        description: "Premium brick construction with superior finishes and fittings",
        icon: Crown,
    ...
    {
        name: "Elite",
        subtitle: "Ultimate Luxury Package",
        price: 3300,
        description: "Top-tier specification with wire-cut bricks and luxury amenities",
        icon: Gem,
